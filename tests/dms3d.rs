...
mod dms3d {
    ...
    #[test]
    fn test_distance() {
        let dms1 = DMS3d::from_ddeg_angles(
            // NY
            40.730610_f64,
            -73.935242_f64,
            Some(10.0),
        );
        let dms2 = DMS3d::from_ddeg_angles(
            // Paris
            48.856614,
            2.3522219,
            Some(10.0),
    ...
    fn test_to_cartesian() {
        let coords = DMS3d::from_ddeg_angles(-33.8698439, 151.2082848, None).to_cartesian();
    ...
    fn test_from_cartesian() {
        ...
        let coords1 = DMS3d::from_ddeg_angles(-33.8698439, 151.2082848, None);
